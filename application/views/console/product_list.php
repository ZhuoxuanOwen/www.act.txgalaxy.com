                ...
                <table class="table table-bordered data-table dataTable" id="DataTables_Table_0">
                    ...
                    <tr role="row">
                        ...
                        <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0"
                            ...
                            style="width: 153px;">
                            <div class="DataTables_sort_wrapper">主图<span
                    ...
                    <?php foreach($productList as $k => $pro) :?>
                        <tr class="gradeA odd">
                            <td class=" sorting_1"><?php echo $pro['product_title']?></td>
                            <td class="center ">
                                <img src="/<?php echo $pro['product_img']?>">
                            </td>
                            <td class=" "><?php echo $pro['product_model']?></td>
                            <td class=" "><?php echo $pro['product_type_id']?></td>
                            <td class="center "><?php echo $pro['product_title']?></td>
                            <td class="left">
...
<script language="javascript">
    ...
    $(document).ready(function(){
        ...
        $("#addProduct").click(function(){
            location.href="/console/product/add";
        });
